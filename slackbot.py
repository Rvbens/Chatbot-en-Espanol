...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', metavar='path', default=None, help='Path to the folder with the saved voc and checkpoint')
    parser.add_argument('--load_quant', metavar='path', default="True", help='Loading a quantized model')
    ...
    if args.model == 'seq2seq':
        ...
        evaluateOneInput = chatbot.evaluateOneInput
    else:
